...
```js live=true id=what-is-prog-hello-world
$text("Hello world!");
```
...
You should go play around with this example - so that you too can be an official "programmer"! Replace the world `world` with your own name in the computer instructions above, and then press the Play button to run your program. After doing this, you should see something your own name showing up on the canvas!
